...
export default function App() {
  ...
  const filteredRecipes = useMemo(() => {
    ...
    return recipes.filter((recipe) =>
      `${recipe.title} ${recipe.chef}`.toLowerCase().includes(term)
    );
  }, [search]);
          ...
          <div className="container">
            <div className="hero">
              <div className="hero-content">
                ...
                <p>
                  Conecte-se com chefs e restaurantes, encontre receitas autênticas
                  e transforme cada preparo em uma experiência.
                </p>
                <div className="hero-actions">
                  <button className="button button-light" onClick={scrollToRecipes}>
                    Explorar receitas <Icon name="arrow" size={18} />
                  </button>
                  <button className="button button-outline" onClick={() => alert("Área de cadastro em breve!")}>
                    Criar conta
                  </button>
                </div>
              </div>
              <div className="hero-image">
                <img
                  ...
                  alt="Pessoa preparando uma receita"
                />
          ...
          <div className="container">
            <div className="section-heading">
              <div>
                ...
                <p>Conteúdos selecionados para você cozinhar algo especial hoje.</p>
              </div>
          ...
          <div className="container">
            ...
            <div className="steps">
              <div className="step">
                <span>01</span>
                <h3>Escolha</h3>
                <p>Encontre receitas e aulas por categoria, tempo e dificuldade.</p>
              </div>
              <div className="step">
                <span>02</span>
                <h3>Aprenda</h3>
                <p>Acesse o conteúdo do chef e acompanhe o preparo passo a passo.</p>
              </div>
              <div className="step">
                <span>03</span>
                <h3>Prepare</h3>
                <p>Compre o conteúdo e, quando disponível, o kit de ingredientes.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="cta-section">
          <div className="container">
            <div className="cta">
              ...
              <button className="button button-orange" onClick={() => alert("Cadastro em breve!")}>
